...
function ListCodeButton() {
  const data = [
    ...
    {label: "Up Arrow", action: "{UP_ARROW}" },
    {abel:"Down Arrow",action: "{DOWN_ARROW}"},
    {abel:"Up Arrow",action: "{UP_ARROW}"},
    {abel:"Left Arrow",action:"{LEFT_ARROW}"},
    {abel:"Right Arrow",action:"{RIGHT_ARROW}"},
